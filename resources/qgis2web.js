...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:25830',
            //extent: [100415.824826, 3977001.683097, 621298.021633, 4288704.757743],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([64942.980337, 3951260.708966, 704176.313670, 4308554.042299], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">TET Andalusia - Summer Restrictions</h2>';
        return titleElement;
    })(),
